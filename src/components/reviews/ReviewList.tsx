  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-lg font-semibold text-gray-900">{t('gig.reviews')} ({reviews.length})</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
          <div className="flex items-center gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500 mt-1">{reviews.length} {t('gig.reviews').toLowerCase()}</div>
            </div>
      ...
      <div className="space-y-4">
        ...
        {reviews.length === 0 && (
          <div className="text-center py-8 text-gray-500">
            <p className="text-sm">{t('gig.noReviews')}. {t('gig.beFirst')}</p>
          </div>
        )}
      </div>
    </div>
